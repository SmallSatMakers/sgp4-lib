 ...
 */
     ...
     */
        ...
        /**
         * @brief Update TLE data from using Line 1 and Line 2 strings
         * 
         * @param line_one 
         * @param line_two 
         */
        void Update(const std::string &line_one,
                    const std::string &line_two)
        {
            line_one_ = line_one;
            line_two_ = line_two;
        ...
        /**
         * @brief Update TLE Data from network URL
         * 
         * @param url Network URL
         */
        void UpdateFromNetwork(const char *url);
        ...
        {
            if (!initd) throw TleException("TLE object not initialized");
            return name_;
        }
...
/**
 * @brief Read multiple TLEs from a file
 * 
 * @param fname File name
 * @return Vector of TLE objects
 */
